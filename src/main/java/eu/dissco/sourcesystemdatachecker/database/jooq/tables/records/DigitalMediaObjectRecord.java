 ...
 */
package eu.dissco.sourcesystemdatachecker.database.jooq.tables.records;
...
public class DigitalMediaObjectRecord extends UpdatableRecordImpl<DigitalMediaObjectRecord> {
  ...
  /**
   * Setter for <code>public.digital_media_object.physicalSpecimenId</code>.
   */
  ...
  /**
   * Getter for <code>public.digital_media_object.physicalSpecimenId</code>.
   */
  public String getId() {
    return (String) get(0);
  }
