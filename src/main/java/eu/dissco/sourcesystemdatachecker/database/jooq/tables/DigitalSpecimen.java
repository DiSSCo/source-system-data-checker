 ...
 */
package eu.dissco.sourcesystemdatachecker.database.jooq.tables;


import eu.dissco.sourcesystemdatachecker.database.jooq.Indexes;
import eu.dissco.sourcesystemdatachecker.database.jooq.Keys;
import eu.dissco.sourcesystemdatachecker.database.jooq.Public;
import eu.dissco.sourcesystemdatachecker.database.jooq.tables.records.DigitalSpecimenRecord;
...
public class DigitalSpecimen extends TableImpl<DigitalSpecimenRecord> {
  ...
  /**
   * The column <code>public.digital_specimen.physicalSpecimenId</code>.
   */
   ...
   */
  public final TableField<DigitalSpecimenRecord, Short> MIDSLEVEL = createField(
      DSL.name("midslevel"), SQLDataType.SMALLINT.nullable(false), this, "");
   ...
   */
  public final TableField<DigitalSpecimenRecord, String> SPECIMEN_NAME = createField(
      DSL.name("specimen_name"), SQLDataType.CLOB, this, "");

  /**
   * The column <code>public.digital_specimen.organization_id</code>.
   */
  public final TableField<DigitalSpecimenRecord, String> ORGANIZATION_ID = createField(
      DSL.name("organization_id"), SQLDataType.CLOB.nullable(false), this, "");

  /**
   * The column <code>public.digital_specimen.source_system_id</code>.
   */
  public final TableField<DigitalSpecimenRecord, String> SOURCE_SYSTEM_ID = createField(
      DSL.name("source_system_id"), SQLDataType.CLOB.nullable(false), this, "");
   ...
   */
  public final TableField<DigitalSpecimenRecord, Instant> LAST_CHECKED = createField(
   ...
   */
  public final TableField<DigitalSpecimenRecord, JSONB> DATA = createField(DSL.name("data"),
      SQLDataType.JSONB, this, "");

  /**
   * The column <code>public.digital_specimen.original_data</code>.
   */
  public final TableField<DigitalSpecimenRecord, JSONB> ORIGINAL_DATA = createField(
      DSL.name("original_data"), SQLDataType.JSONB, this, "");
