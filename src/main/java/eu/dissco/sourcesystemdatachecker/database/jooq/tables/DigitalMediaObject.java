...
import eu.dissco.sourcesystemdatachecker.database.jooq.tables.records.DigitalMediaObjectRecord;
...
public class DigitalMediaObject extends TableImpl<DigitalMediaObjectRecord> {
  ...
  /**
   * The column <code>public.digital_media_object.physicalSpecimenId</code>.
   */
